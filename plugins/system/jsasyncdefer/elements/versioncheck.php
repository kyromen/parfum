...
class JFormFieldVersionCheck extends JFormField {
	...
	public function getInput()	{
		if (strval($this->element['pluginfolder']) && strval($this->element['pluginname'])) {
			$pluginfolder = strval($this->element['pluginfolder']);
			$pluginname = strval($this->element['pluginname']);
		...
		$versioncat  = strval($this->element['versioncat']);
		...
		$msg .= JText::_('PLG_DAYCOUNTS_LATEST_VERSION').$versionCheck['latest'].'&nbsp;';

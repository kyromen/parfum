...
$Id: default_staddress.php 7 2015-01-22 17:26:52Z abhishekdas $
----------------------------------------------------------------------------------------------------------*/
		...
		<div class="edit-address<?php echo ($this->cart->STsameAsBT == 1) ? '' : ' soft-show'; ?>">
			<?php if(!empty($this->stFields['fields'])) : ?>
				<form id="EditSTAddres" autocomplete="off">
					...
					<input type="hidden" name="shipto_virtuemart_userinfo_id" id="shipto_virtuemart_userinfo_id" value="<?php echo isset($this->cart->ST['virtuemart_userinfo_id']) ? $this->cart->ST['virtuemart_userinfo_id'] : 0; ?>"/>
				</form>
			<?php endif; ?>
		</div>
	</div>

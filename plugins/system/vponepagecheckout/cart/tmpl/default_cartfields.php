...
<!--					<label for="--><?php //echo $field['name'] ?><!--_field" class="comment">--><?php //echo $field['title'] ?><!--</label>-->
					<?php $field['formcode'] = str_replace('rows="1"', 'rows="40"', $field['formcode']); ?>
					<?php echo strpos($field['formcode'], 'class="') ?
					str_replace('class="', 'placeholder="Примечания и особые просьбы" class="customer-comment proopc-customer-comment ', $field['formcode']) :

...
<div class="proopc-finalpage">
	<div class="proopc-row">
		<h1 class="cart-page-title"><?php echo JText::_ ('COM_VIRTUEMART_CART_TITLE'); ?>
			<span>
				<?php
					if ($this->productsCount > 10 and $this->productsCount < 20) echo JText::sprintf('COM_VIRTUEMART_CART_X_PRODUCTS', $this->productsCount);
					else if (in_array($this->productsCount % 10, array(5,6,7,8,9,0)) and ($this->productsCount != 0)) echo JText::sprintf('COM_VIRTUEMART_CART_X_PRODUCTS', $this->productsCount);
					else if (in_array($this->productsCount % 10, array(2,3,4))) echo JText::sprintf('COM_VIRTUEMART_CART_X2_PRODUCTS', $this->productsCount);
					else if ($this->productsCount % 10 == 1) echo JText::_('COM_VIRTUEMART_CART_ONE_PRODUCT');
					else $this->productsCount = JText::_('COM_VIRTUEMART_EMPTY_CART');
				?>
			</span>
		</h1>
	</div>
...
<!--			<h3 class="proopc-process-title">--><?php //echo $this->params->get('oncheckout_show_steps', 1) ? '<div class="proopc-step">'.($checkout_step++).'</div>' : '' ?><!----><?php //echo JText::_('COM_VIRTUEMART_ORDER_CONFIRM_MNU')?><!--</h3>-->
	...
	<div class="proopc-column3" style="display: none;">

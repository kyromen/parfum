(function (e, t) {
    if (typeof exports == "object")module.exports = t(); else if (typeof define == "function" && define.amd)define(t); else e.VPSpinner = t()
})(this, function () {
    "use strict";
    function r(e, t) {
    ...
    function f(e) {
        for (var t = 1; t < arguments.length; t++) {
            var n = arguments[t];
            for (var r in n)if (e[r] === undefined)e[r] = n[r]
        }
        return e
    }
        ...
        p.prototype.lines = function (t, n) {
            ...
            function h(t, s, u) {
                i(f, i(a(o(), {
                    ...
                    top: -n.width >> 1,
                    filter: u
                }), e("fill", {color: c(n.color, t), opacity: n.opacity}), e("stroke", {opacity: 0}))))
            }

            var r = n.length + n.width, s = 2 * r;
            var u = -(n.width + n.length) * 2 + "px", f = a(o(), {position: "absolute", top: u, left: u}), l;
    ...
    f(p.prototype, {
        spin: function (e) {
            this.stop();
            var t = this, i = t.opts, s = t.el = a(r(0, {className: i.className}), {
                position: i.position,
                width: 0,
                zIndex: i.zIndex
            ...
            for (; s < t.lines; s++) {
                ...
                if (t.shadow)i(f, a(l("#000", "0 0 4px " + "#000"), {top: 2 + "px"}));
    ...
    var v = a(r("group"), {behavior: "url(#default#VML)"});
    if (!u(v, "transform") && v.adj)d(); else n = u(v, "animation");
    return p
});
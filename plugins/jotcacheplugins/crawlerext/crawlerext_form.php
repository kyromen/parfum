...
<form action="<?php echo JRoute::_('index.php?option=com_jotcache'); ?>" method="post" name="adminForm_crawlerext" id="adminForm_Crawlerext">
  ...
  <table class="adminlist" style="width:400px;">
    <tr>
      <td style="padding-left: 0px;" class="hasTip" title="<?php echo JText::_('PLG_JCPLUGINS_CRAWLEREXT_DEPTH_DESC'); ?>"><?php echo JText::_('PLG_JCPLUGINS_CRAWLEREXT_DEPTH'); ?> </td>
      <td style="padding-left: 0px;"><?php echo JHTML::_('select.genericlist', $depthOptions, 'jcstates[depth]', 'style="width:100px;"', 'value', 'text', $depth); ?></td>
    </tr>
  </table>

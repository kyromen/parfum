...
$html .= '<div class="mCustomScrollbar content fluid light custom_params custom_params-'.$type->virtuemart_custom_id.'">';
...
if(!empty($customfield_value)){
	$html .= '<div class="mCustomScrollbar content fluid light values cv-'.$type->virtuemart_custom_id.$custom_class.'" data-id="'.$type->virtuemart_custom_id.'"'.$custom_pid.$custom_pval.'>';

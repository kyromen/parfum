...
if(!empty($customfield_value)){
	$html .= '<ul class="mCustomScrollbar content fluid light values cv-'.$type->virtuemart_custom_id.$custom_class.'" data-id="'.$type->virtuemart_custom_id.'"'.$custom_pid.$custom_pval.'>';

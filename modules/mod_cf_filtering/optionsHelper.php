...
class ModCfilteringOptions{
	 ...
	 * @since	2.2.0
	 */
	function getRelativePriceRanges(){
	 ...
	 * @since	2.2.0
	 */
	function caclFinalPrice($ranges){
	 ...
	 * @since 2.2.2
	 */
	function addCalcRulesByCalcType($price, $calc_group){
	 ...
	 * @since 2.2.2
	 */
	function addCalcRule($price, $calc ){
	 ...
	 * @since	2.2.2
	 */
	function buildPriceRangeQuery($query,$part=false){

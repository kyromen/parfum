...
class SEFModelWords extends SEFModel
{
    ...
    function getLists()
    {
        ...
        $lists['filterWords']  = "<input class=\"hasTip\" type=\"text\" name=\"filterWords\" value=\"{$this->filterWords}\" size=\"40\" maxlength=\"255\" onchange=\"document.adminForm.submit();\" title=\"".JText::_('COM_SEF_TT_FILTER_WORDS')."\" />";

...
class SEFModelHtaccess extends SEFModel
{
    ...
    {
        $this->_parsed = false;
        $this->_file = JPATH_ROOT.'/.htaccess';
    ...
    function getLists()
    {
        ...
        $lists['symLinksEnable'] = $this->booleanRadio('symLinksEnable', 'class="inputbox"', $this->_symLinksEnabled);
        $lists['baseEnable'] = $this->booleanRadio('baseEnable', 'class="inputbox"', $this->_baseEnabled);

...
{
    var res = confirm('<?php echo JText::_('COM_SEF_CONFIRM_SITEMAP_UPDATE'); ?>');
    if( res ) {
        alert('<?php echo JText::_('COM_SEF_INFO_DONT_INTERRUPT'); ?>');
    }
    return res;
...
<div class="sef-width-60 fltlft">
	<div class="icons" id="cpanel">
		...
		<div class="extras">
            ...
            <!--  Update Sitemap -->
            <div class="icon">
                <a href="index.php?option=com_sef&amp;controller=sefurls&amp;task=updatesitemap" onclick="return updateSitemapWarning();" title="Update URLs sitemap parameters after configuration change">
                    <img src="components/com_sef/assets/images/icon-48-update-sitemap.png" alt="" width="48" height="48" align="middle" border="0"/>
                    <span><?php echo JText::_('COM_SEF_UPDATE_SITEMAP'); ?></span>
                </a>
            </div>
            <div style="clear: both;"></div>

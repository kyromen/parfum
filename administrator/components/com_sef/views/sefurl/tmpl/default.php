...
?>
	...
	if(JRequest::getInt('viewmode')!=6) {
		...
		<fieldset class="adminform">
		   <legend><?php echo JText::_('COM_SEF_SITEMAP'); ?></legend>
		   <table class="admintable table">
		       <tr>
		           <td class="key"><?php echo JText::_('COM_SEF_INDEXED'); ?></td>
		           <td><?php echo $this->lists['sm_indexed']; ?><?php echo $this->tooltip(JText::_('COM_SEF_TT_SM_INDEXED'), JText::_('COM_SEF_INDEXED'));?></td>
		       </tr>
		       <tr>
		           <td class="key"><?php echo JText::_('COM_SEF_DATE'); ?></td>
		           <td><?php echo $this->lists['sm_date']; ?><?php echo $this->tooltip(JText::_('COM_SEF_TT_SM_DATE'), JText::_('COM_SEF_DATE'));?></td>
		       </tr>
		       <tr>
		           <td class="key"><?php echo JText::_('COM_SEF_CHANGE_FREQUENCY'); ?></td>
		           <td><?php echo $this->lists['sm_frequency']; ?><?php echo $this->tooltip(JText::_('COM_SEF_TT_SM_FREQUENCY'), JText::_('COM_SEF_CHANGE_FREQUENCY'));?></td>
		       </tr>
		       <tr>
		           <td class="key"><?php echo JText::_('COM_SEF_PRIORITY'); ?></td>
		           <td><?php echo $this->lists['sm_priority']; ?><?php echo $this->tooltip(JText::_('COM_SEF_TT_SM_PRIORITY'), JText::_('COM_SEF_PRIORITY'));?></td>
		       </tr>
		   </table>
		</fieldset>
	...
	if(JRequest::getInt('viewmode')!=6) {
		...
		<fieldset class="adminform">
		   <legend><?php echo JText::_('COM_SEF_INTERNAL_LINKS'); ?></legend>
		   <table class="admintable table">
		       <tr>
		           <td class="key" valign="top"><?php echo JText::_('COM_SEF_LINKED_WORDS'); ?></td>
		           <td>
	    	           <?php echo $this->lists['words']; ?>
	    	           <div class="clr"></div>
	    	           <input type="button" class="btn" value="<?php echo JText::_('COM_SEF_REMOVE_SELECTED'); ?>" onclick="removeWords();" />
		           </td>
		       </tr>
		       <tr>
		           <td class="key" valign="top"><?php echo JText::_('COM_SEF_ADD_WORD'); ?></td>
		           <td>
	    	           <input type="text" autocomplete="off" name="txtWord" id="txtWord" size="40" style="width: 250px;" onblur="hideAutoComplete();" onkeydown="handleKey(event, addWord);" onkeyup="showAutoComplete(this, event, 'wordid', 'ajax', 'findWords');" />
	    	           <input type="button" class="btn" value="<?php echo JText::_('COM_SEF_ADD_WORD'); ?>" onclick="addWord();" />
		           </td>
		       </tr>
		   </table>

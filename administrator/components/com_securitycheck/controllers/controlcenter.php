...
function generate()
{
	...
	$model->setValue("secret_key",$key,'','controlcenter');
	$model->save('controlcenter');
	$url = 'index.php?option=com_securitycheck&controller=controlcenter&view=controlcenter&'. JSession::getFormToken() .'=1';

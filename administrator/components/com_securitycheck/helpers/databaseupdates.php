...
function tarea_comprobacion() {
	...
	if ( $this->securitycheck_type == 'Not_defined' ) {
		...
		if ( empty($downloadid) ) {
			...
			$xmlfile = "http://securitycheck.protegetuordenador.com/index.php/downloads/securitycheck-pro-database-updates-xml/securitycheck-pro-database-updates-xml-1-0-0/databases-xml?dlid=" . $downloadid;

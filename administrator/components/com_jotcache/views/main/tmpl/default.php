...
$mark_qs = JText::_('JOTCACHE_RS_SEL_MARK_YES');
          ...
          <tr class="<?php echo "row$k"; ?>" <?php echo $expired; ?>>
            ...
            <td><a href="#" class="modal" onclick="alertBox('<?php echo $qs; ?>');" title="<?php echo JText::_('JOTCACHE_RS_QS_TITLE'); ?>"><i class="icon-eye"></i></a>
            <?php if ($mode) { ?>
              <a  href="<?php echo $row->uri; ?>" target="_blank" title="<?php echo $row->title; ?>"><?php echo $row->uri; ?></a></td>
            <?php } else { ?>
